...
public class WeekView
{
	...
	@Test(priority=1)
	public void testWeekView() throws InterruptedException{
	{
	 ...
	 String un=Lib.getCellValue(IAutoConst.XLPATH,"ValidLogin",1,0);
		...
		String R3=Lib.getCellValue(IAutoConst.XLPATH,"Scheduling",1,1);
	 ...
	 public void testisPatientPresent()
	  {
	            ...
	            try{
	                driver.findElement(By.xpath("//p[contains(text(),'James San')]"));
	            }
